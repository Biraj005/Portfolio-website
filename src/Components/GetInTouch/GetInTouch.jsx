    ...
    <div id='contact'  className='main-container'>
        ...
        <div className='get-in-touch-wraper'>
            ...
            <div className="contact-details">
                <div className="contact-details-list"><img src="/email.png" alt="email" /><span>birajroy0007@gmail.com</span></div>
                <div className="contact-details-list"><img src="/call.png" alt="email" /><span>7810941767</span></div>
                <div className="contact-details-list"><img src="/gps.png" alt="address" /><span>West Bengal,India</span></div>
            </div>
            </div>
            <div className='form'>
                <form action="">
